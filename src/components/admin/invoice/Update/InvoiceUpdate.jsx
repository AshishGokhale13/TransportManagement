...
import { getinvoiceData, saveInvoice, updateInvoice } from '../../../../services/invoiceService';
...
function InvoiceUpdate() {
    ...
    const formData=useMemo(()=>oldformData,[oldformData])
    const { id } = useParams();
    ...
    useEffect(() => {
        ...
        const handleSubmit = (event) => {
            ...
            // console.log(lorryOwnerMobile.match(/^\d+$/));
            ...
            updateInvoice(id,formData).then(data => {
                    ...
                    if(data.statusCode===200  )
                    {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Invalid Data',
                            text: 'please provide valida data to modify',
                          });
                    }
        ...
        return (
            ...
            <Card className='px-3 mt-3 py-4 d-flex flex-row justify-content-between'>
                <h5 className='text-danger'> No record found..... </h5>
